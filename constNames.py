...
class ConstNames(object):
  ...
  def drawConstNames(self,ax,color="k",fontsize=16.0,weight="normal"):
    for const in self.centroids:
      ...
      try:
        ax.text(ra,de,self.abbrevs[const],fontsize=fontsize,va="center",ha="center",color=color,weight=weight)
      except:
        ax.ax.text(ra,de,self.abbrevs[const],fontsize=fontsize,va="center",ha="center",color=color,weight=weight)
